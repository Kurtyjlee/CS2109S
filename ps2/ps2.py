...
def test_heuristic(case):
    ...
    assert (
        heuristic_func(problem, problem.goal) == 0
    ), "Heuristic is not 0 at the goal state"
    assert (
        heuristic_func(problem, problem.initial) <= answer["cost"]
...
if __name__ == "__main__":
    ...
    cube2 = {
        "input_dict": {
            "initial": {
                "shape": [3, 3],
                "layout": ["S", "O", "C", "S", "O", "C", "S", "O", "C"],
            },
            "goal": {
                "shape": [3, 3],
                "layout": ["S", "S", "S", "O", "O", "O", "C", "C", "C"],
            },
        },
        "answer": {
    ...
    cube4 = {
        "input_dict": {
            "initial": {
                "shape": [3, 4],
                "layout": [1, 1, 9, 0, 2, 2, 0, 2, 9, 0, 1, 9],
            },
            "goal": {"shape": [3, 4], "layout": [1, 0, 9, 2, 2, 1, 0, 9, 2, 1, 0, 9]},
        },
        "answer": {"solution": [[1, "down"], [3, "up"], [2, "left"]], "cost": 3},
    }
...
def evaluation_func(
    cities: int, distances: List[Tuple[int]], route: List[int]
) -> float:
    r"""
...
def hill_climbing_with_random_restarts(
    cities: int, distances: List[Tuple[int]], repeats: int = 10
):
    r"""
